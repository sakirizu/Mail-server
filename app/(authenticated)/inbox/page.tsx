  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen bg-white">
        <p className="text-base text-gray-500">メールを読み込み中...</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex-1 bg-gradient-to-br from-white via-[rgba(255,244,235,0.7)] to-white">
        <div className="flex flex-col items-center justify-center h-full px-8">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500 to-amber-400 flex items-center justify-center text-white text-2xl font-semibold shadow-medium mb-4">
            S
          </div>
      ...
      <div className="px-8 py-5 border-b border-[var(--border)] bg-white/80 backdrop-blur-sm">
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            {unreadCount > 0 && (
              <div className="inline-flex items-center gap-2 rounded-full bg-primary-50/80 text-primary-700 px-4 py-1 text-xs font-medium shadow-soft">
